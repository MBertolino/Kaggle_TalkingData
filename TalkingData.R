...
label_train <- fread("/home/mattias/R/Kaggle/TalkingData/gender_age_train.csv",
                     colClasses = c("character", "character",
                                  "integer", "character"))
label_test <- fread("/home/mattias/R/Kaggle/TalkingData/gender_age_test.csv",
...
brand <- brand[-which(duplicated(brand$device_id)),]
label1 <- merge(label, brand, by = "device_id", all.x = T)
rm(brand); gc()

# apps
events <- fread("/home/mattias/R/Kaggle/TalkingData/events.csv",
                colClasses = c("character", "character", "character",
                             "numeric", "numeric"))
setkeyv(events, c("device_id", "event_id"))
event_app <- fread("/home/mattias/R/Kaggle/TalkingData/app_events.csv",
...
write.csv(res_submit, file = "/home/mattias/R/Kaggle/TalkingData/talkingdata_mbertolino_1.csv", row.names = F,quote = F)
